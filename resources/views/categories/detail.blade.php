                    ...
                    <ul class="seq-canvas">
                        ...
                        @foreach($events as $event)
                            <li>
                                ...
                                <div class="seq-title">
                                    <span data-seq>Sale up to: {{ $event->promotion_price }}%</span>
